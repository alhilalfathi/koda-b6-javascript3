...
// 13. trimEnd() atau trimRight() : digunakan sama seperti trim() namun hanya menghilangkan string kosong pada bagian belakang sebuah string
 ...
 // 15. parseInt() : digunakan untuk parsing data argumen dan mengembalikan nilai integer
 let s = Number.parseInt("10");
 console.log(s)
 // 16. parseFloat() : digunakan untuk parsing argumen dan mengembalikan nilai float
 let n = Number.parseFloat("10");
 console.log(n)
